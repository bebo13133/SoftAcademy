        ...
        <>
            <section className="project-section">
                <section className="project-section-second">
                    ...
                    <div className="description-project" style={{textTransform: "none"}}> {description} <Link to={youtube} target="_blank" >demo video</Link>.</div>
                    <div className="description-project" style={{textTransform: "none"}}>Website:  <Link to={website} target="_blank"> {website} </Link></div>
